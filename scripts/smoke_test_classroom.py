...
def main() -> int:
    ...
    if Path("backend/main.py").exists() and Path("frontend").exists():
        print("INFO: Real MiroFish project structure appears present.")
    else:
        print("INFO: Real MiroFish backend/frontend not detected; current run path is scaffold + fallback script.")
